...
var $;
(function ($) {
    class $hyoo_toys_toy extends $mol_object {
        static data() {
            return $mol_fetch.json('hyoo/toys/toy/toy_data.json');
        }
        static all() {
        ...
        image() {
            return `hyoo/toys/toy/thumbs/${this.id().substring(0, 2)}.jpg`;
        }
        title() {
        ...
        reviews() {
            ...
            if (Math.random() > $hyoo_toys_toy.luck())
    ...
    __decorate([
        $mol_mem
    ], $hyoo_toys_toy.prototype, "data", null);
    __decorate([
        $mol_mem
    ], $hyoo_toys_toy.prototype, "image", null);
    __decorate([
        $mol_mem
    ], $hyoo_toys_toy.prototype, "price", null);
    __decorate([
        $mol_mem
    ], $hyoo_toys_toy.prototype, "seed", null);
    __decorate([
        $mol_mem
    ], $hyoo_toys_toy.prototype, "reviews", null);
    __decorate([
        $mol_mem
    ], $hyoo_toys_toy, "data", null);
    __decorate([
        $mol_mem
    ], $hyoo_toys_toy, "all", null);
    __decorate([
        $mol_mem_key
    ], $hyoo_toys_toy, "item", null);
    __decorate([
        $mol_mem
    ], $hyoo_toys_toy, "luck", null);
    $.$hyoo_toys_toy = $hyoo_toys_toy;
})($ || ($ = {}));
...
;
	($.$hyoo_toys_catalog) = class $hyoo_toys_catalog extends ($.$mol_page) {
		event_top(next){
			if(next !== undefined) return next;
			return null;
		}
		Logo(){
			...
			(obj.uri) = () => ("hyoo/toys/toys_logo.svg");
			(obj.event) = () => ({"click": (next) => (this.event_top(next))});
			return obj;
		}
		filter_title(next){
			if(next !== undefined) return next;
		...
		Filter_title(){
			...
			(obj.query) = (next) => ((this.filter_title(next)));
			return obj;
		}
		Source_link(){
			const obj = new this.$.$mol_link_source();
			(obj.uri) = () => ("https://github.com/hyoo-ru/toys.hyoo.ru");
			return obj;
		}
		toy_cards(){
			return [];
		...
		Toy_main(id){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ([(this.Toy_title(id)), (this.Toy_type(id))]);
			return obj;
		}
		toy_image(id){
			return "";
		...
		Toy_image(id){
			...
			(obj.style) = () => ({"filter": (this.toy_image_filter(id))});
			return obj;
		}
		toy_price(id){
		...
		Toy_price(id){
			...
			(obj.value) = () => ((this.toy_price(id)));
			return obj;
		}
		toy_size_prefix(){
			return (this.$.$mol_locale.text("$hyoo_toys_catalog_toy_size_prefix"));
		}
		toy_size(id){
			return "";
		}
		Toy_size(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.toy_size_prefix()), (this.toy_size(id))]);
			return obj;
		}
		toy_reviews_prefix(){
			return (this.$.$mol_locale.text("$hyoo_toys_catalog_toy_reviews_prefix"));
		}
		toy_reviews(id){
			return 0;
		}
		Toy_reviews(id){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.toy_reviews_prefix()), (this.toy_reviews(id))]);
			return obj;
		}
		Toy_info(id){
			const obj = new this.$.$mol_view();
		...
		tools(){
			return [(this.Filter_title()), (this.Source_link())];
		}
		body(){
			return [(this.Goods())];
		}
	...
	($mol_mem(($.$hyoo_toys_catalog.prototype), "event_top"));
	($mol_mem(($.$hyoo_toys_catalog.prototype), "Logo"));
	($mol_mem(($.$hyoo_toys_catalog.prototype), "filter_title"));
	($mol_mem(($.$hyoo_toys_catalog.prototype), "Filter_title"));
	($mol_mem(($.$hyoo_toys_catalog.prototype), "Source_link"));
	($mol_mem(($.$hyoo_toys_catalog.prototype), "Goods"));
	($mol_mem_key(($.$hyoo_toys_catalog.prototype), "Toy_title"));
	($mol_mem_key(($.$hyoo_toys_catalog.prototype), "Toy_type"));
	($mol_mem_key(($.$hyoo_toys_catalog.prototype), "Toy_main"));
	($mol_mem_key(($.$hyoo_toys_catalog.prototype), "Toy_image"));
	($mol_mem_key(($.$hyoo_toys_catalog.prototype), "toy_price"));
	($mol_mem_key(($.$hyoo_toys_catalog.prototype), "Toy_price"));
	($mol_mem_key(($.$hyoo_toys_catalog.prototype), "Toy_size"));
	($mol_mem_key(($.$hyoo_toys_catalog.prototype), "Toy_reviews"));
	($mol_mem_key(($.$hyoo_toys_catalog.prototype), "Toy_info"));
	($mol_mem_key(($.$hyoo_toys_catalog.prototype), "toy"));
	($mol_mem_key(($.$hyoo_toys_catalog.prototype), "Toy_card"));
...
(function ($) {
    ...
    (function ($$) {
        class $hyoo_toys_catalog extends $.$hyoo_toys_catalog {
            ...
            sorter() {
                return {
                    price: (a, b) => a.price().valueOf() - b.price().valueOf(),
                    title: (a, b) => a.title() < b.title() ? -1 : a.title() > b.title() ? 1 : 0,
                    size: (a, b) => a.size() < b.size() ? -1 : a.size() > b.size() ? 1 : 0,
                }[this.sort_key()];
            }
            tools_visible(next) {
        ...
        __decorate([
            $mol_mem
        ], $hyoo_toys_catalog.prototype, "size_average", null);
        __decorate([
            $mol_mem
        ], $hyoo_toys_catalog.prototype, "toys_filtered_by_type", null);
        __decorate([
            $mol_mem
        ], $hyoo_toys_catalog.prototype, "toys_filtered_by_size", null);
        __decorate([
            $mol_mem
        ], $hyoo_toys_catalog.prototype, "filter_title", null);
        __decorate([
            $mol_mem
        ], $hyoo_toys_catalog.prototype, "toys_filtered_by_title", null);
        __decorate([
            $mol_mem
        ], $hyoo_toys_catalog.prototype, "toys_filtered_by_popularity", null);
        __decorate([
            $mol_mem
        ], $hyoo_toys_catalog.prototype, "toys_filtered", null);
        __decorate([
            $mol_mem
        ], $hyoo_toys_catalog.prototype, "toys_sorted", null);
        __decorate([
            $mol_mem
        ], $hyoo_toys_catalog.prototype, "sorter", null);
        __decorate([
            $mol_mem
        ], $hyoo_toys_catalog.prototype, "tools_visible", null);
        __decorate([
            $mol_mem
        ], $hyoo_toys_catalog.prototype, "toy_cards", null);
...
;
	($.$hyoo_toys_details) = class $hyoo_toys_details extends ($.$mol_page) {
		Close_icon(){
			const obj = new this.$.$mol_icon_cross();
			return obj;
		}
		...
		Photo(){
			...
			(obj.style) = () => ({"filter": (this.photo_filter())});
			return obj;
		}
		Image(){
			const obj = new this.$.$mol_view();
		...
		buy(){
			return (this.$.$mol_locale.text("$hyoo_toys_details_buy"));
		}
		price(){
			const obj = new this.$.$mol_unit_money();
			(obj.valueOf) = () => (0);
		...
		Buy_button(){
			...
			(obj.sub) = () => ([(this.buy()), (this.Price())]);
			return obj;
		}
		Buy_link(){
			const obj = new this.$.$mol_link();
			(obj.uri) = () => ("http://boosty.to/hyoo");
			(obj.sub) = () => ([(this.Buy_button())]);
			return obj;
		}
		type(){
			return "";
		...
		size_prefix(){
			return (this.$.$mol_locale.text("$hyoo_toys_details_size_prefix"));
		}
		size(){
			return "";
		}
		Size(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.size_prefix()), (this.size())]);
			return obj;
		}
		reviews_prefix(){
			return (this.$.$mol_locale.text("$hyoo_toys_details_reviews_prefix"));
		}
		reviews(){
			return 0;
		}
		Reviews(){
			const obj = new this.$.$mol_view();
			(obj.sub) = () => ([(this.reviews_prefix()), (this.reviews())]);
			return obj;
		}
		Parameters(){
			const obj = new this.$.$mol_view();
		...
		Info(){
			...
			(obj.sub) = () => ([(this.Buy_link()), (this.Parameters())]);
			return obj;
		}
		Main(){
			const obj = new this.$.$mol_row();
			(obj.sub) = () => ([(this.Image()), (this.Info())]);
			return obj;
		}
		Description(){
	...
	($mol_mem(($.$hyoo_toys_details.prototype), "Close_icon"));
	($mol_mem(($.$hyoo_toys_details.prototype), "Close"));
	($mol_mem(($.$hyoo_toys_details.prototype), "Photo"));
	($mol_mem(($.$hyoo_toys_details.prototype), "Image"));
	($mol_mem(($.$hyoo_toys_details.prototype), "price"));
	($mol_mem(($.$hyoo_toys_details.prototype), "Price"));
	($mol_mem(($.$hyoo_toys_details.prototype), "Buy_button"));
	($mol_mem(($.$hyoo_toys_details.prototype), "Buy_link"));
	($mol_mem(($.$hyoo_toys_details.prototype), "Type"));
	($mol_mem(($.$hyoo_toys_details.prototype), "Size"));
	($mol_mem(($.$hyoo_toys_details.prototype), "Reviews"));
	($mol_mem(($.$hyoo_toys_details.prototype), "Parameters"));
	($mol_mem(($.$hyoo_toys_details.prototype), "Info"));
	($mol_mem(($.$hyoo_toys_details.prototype), "Main"));
	($mol_mem(($.$hyoo_toys_details.prototype), "Description"));
	($mol_mem(($.$hyoo_toys_details.prototype), "toy"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        $$.$hyoo_toys_details = $hyoo_toys_details;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$hyoo_toys) = class $hyoo_toys extends ($.$mol_book2) {
		search(next){
			if(next !== undefined) return next;
			return null;
		}
		Hotkey(){
			const obj = new this.$.$mol_hotkey();
			(obj.mod_ctrl) = () => (true);
			(obj.key) = () => ({"F": (next) => (this.search(next))});
			return obj;
		}
		filter_type(next){
			if(next !== undefined) return next;
		...
		filter_type_option_all(){
			return (this.$.$mol_locale.text("$hyoo_toys_filter_type_option_all"));
		}
		filter_type_options(){
			return {"all": (this.filter_type_option_all())};
		}
		Filter_type(){
			const obj = new this.$.$mol_switch();
			(obj.value) = (next) => ((this.filter_type(next)));
			(obj.options) = () => ((this.filter_type_options()));
			return obj;
		}
		filter_size(next){
			if(next !== undefined) return next;
		...
		filter_size_option_all(){
			return (this.$.$mol_locale.text("$hyoo_toys_filter_size_option_all"));
		}
		filter_size_options(){
			return {"all": (this.filter_size_option_all())};
		}
		Filter_size(){
			const obj = new this.$.$mol_switch();
			(obj.value) = (next) => ((this.filter_size(next)));
			(obj.options) = () => ((this.filter_size_options()));
			return obj;
		}
		filter_popular(next){
			if(next !== undefined) return next;
		...
		filter_popular_title(){
			return (this.$.$mol_locale.text("$hyoo_toys_filter_popular_title"));
		}
		Filter_popular(){
			const obj = new this.$.$mol_check();
			(obj.checked) = (next) => ((this.filter_popular(next)));
			(obj.title) = () => ((this.filter_popular_title()));
			return obj;
		}
		Filter_flags(){
			const obj = new this.$.$mol_list();
			(obj.rows) = () => ([(this.Filter_popular())]);
			return obj;
		}
		sort_key(next){
			if(next !== undefined) return next;
		...
		sort_option_price(){
			return (this.$.$mol_locale.text("$hyoo_toys_sort_option_price"));
		}
		sort_option_size(){
			return (this.$.$mol_locale.text("$hyoo_toys_sort_option_size"));
		}
		sort_option_title(){
			return (this.$.$mol_locale.text("$hyoo_toys_sort_option_title"));
		}
		sort_items(){
			return {
				"price": (this.sort_option_price()), 
				"size": (this.sort_option_size()), 
				"title": (this.sort_option_title())
			};
		}
		Sort(){
			const obj = new this.$.$mol_switch();
			(obj.value) = (next) => ((this.sort_key(next)));
			(obj.options) = () => ((this.sort_items()));
			return obj;
		}
		toys(){
			return [];
		...
		Catalog(){
			...
			(obj.filter_size) = () => ((this.filter_size()));
			(obj.filter_popular) = () => ((this.filter_popular()));
			(obj.sort_key) = () => ((this.sort_key()));
			return obj;
		}
		Details(id){
			const obj = new this.$.$hyoo_toys_details();
			(obj.toy) = () => ((this.toy_current()));
			return obj;
		}
	};
	($mol_mem(($.$hyoo_toys.prototype), "search"));
	($mol_mem(($.$hyoo_toys.prototype), "Hotkey"));
	($mol_mem(($.$hyoo_toys.prototype), "filter_type"));
	($mol_mem(($.$hyoo_toys.prototype), "Filter_type"));
	($mol_mem(($.$hyoo_toys.prototype), "filter_size"));
	($mol_mem(($.$hyoo_toys.prototype), "Filter_size"));
	($mol_mem(($.$hyoo_toys.prototype), "filter_popular"));
	($mol_mem(($.$hyoo_toys.prototype), "Filter_popular"));
	($mol_mem(($.$hyoo_toys.prototype), "Filter_flags"));
	($mol_mem(($.$hyoo_toys.prototype), "sort_key"));
	($mol_mem(($.$hyoo_toys.prototype), "Sort"));
	($mol_mem_key(($.$hyoo_toys.prototype), "toy"));
	($mol_mem(($.$hyoo_toys.prototype), "Filters"));
	($mol_mem(($.$hyoo_toys.prototype), "Catalog"));
	($mol_mem_key(($.$hyoo_toys.prototype), "Details"));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $hyoo_toys.prototype, "filter_type", null);
        __decorate([
            $mol_mem
        ], $hyoo_toys.prototype, "filter_type_options", null);
        __decorate([
            $mol_mem
        ], $hyoo_toys.prototype, "filter_size", null);
        __decorate([
            $mol_mem
        ], $hyoo_toys.prototype, "filter_size_options", null);
        __decorate([
            $mol_mem

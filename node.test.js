...
(function ($) {
    class $hyoo_toys_toy extends $.$mol_object {
        static data() {
            return $.$mol_http.resource('hyoo/toys/toy/toy_data.json').json();
        }
        static all() {
...
(function ($) {
    class $hyoo_toys_catalog extends $.$mol_page {
         ...
         **/
        head() {
            return [].concat(this.Logo(), this.Title(), this.Tools());
        }
        /**
         *  ```
         *  Logo $mol_image
        ...
        Toy_option(id) {
            return ((obj) => {
                obj.sub = () => [].concat(this.Toy_image(id), this.Toy_info(id));
                return obj;
            })(new this.$.$mol_view());
        }
        /**
        ...
        Toy_info(id) {
            return ((obj) => {
                obj.sub = () => [].concat(this.Toy_price(id), this.Toy_size(id), this.Toy_reviews(id));
                return obj;
            })(new this.$.$mol_view());
        }
        /**
        ...
        Toy_reviews(id) {
            return ((obj) => {
                obj.sub = () => [].concat(this.toy_reviews_prefix(), this.toy_reviews(id));
                return obj;
            })(new this.$.$mol_view());
        }
        /**
...
(function ($) {
    class $hyoo_toys_details extends $.$mol_page {
         ...
         **/
        body() {
            return [].concat(this.Main(), this.Description());
        }
        /**
         *  ```
         *  Main $mol_view sub /
        ...
        Main() {
            return ((obj) => {
                obj.sub = () => [].concat(this.Image(), this.Info());
                return obj;
            })(new this.$.$mol_view());
        }
        /**
        ...
        Info() {
            return ((obj) => {
                obj.sub = () => [].concat(this.Buy_link(), this.Parameters());
                return obj;
            })(new this.$.$mol_view());
        }
        /**
        ...
        Buy_link() {
            return ((obj) => {
                ...
                obj.sub = () => [].concat(this.Buy_button());
                return obj;
            })(new this.$.$mol_link());
        }
        /**
        ...
        Buy_button() {
            return ((obj) => {
                obj.sub = () => [].concat(this.buy(), this.Price());
                return obj;
        ...
        Parameters() {
            return ((obj) => {
                obj.sub = () => [].concat(this.Type(), this.Size(), this.Reviews());
                return obj;
            })(new this.$.$mol_view());
        }
        /**
        ...
        Size() {
            return ((obj) => {
                obj.sub = () => [].concat(this.size_prefix(), this.size());
                return obj;
            })(new this.$.$mol_view());
        }
        /**
        ...
        Reviews() {
            return ((obj) => {
                obj.sub = () => [].concat(this.reviews_prefix(), this.reviews());
                return obj;
            })(new this.$.$mol_view());
        }
        /**
...
(function ($) {
    class $hyoo_toys extends $.$mol_book {
         ...
         **/
        pages() {
            return [].concat(this.Filters(), this.Catalog(), this.Details());
        }
        /**
         *  ```
         *  Filters $mol_page
        ...
        Filters() {
            return ((obj) => {
                ...
                obj.body = () => [].concat(this.Filter_type(), this.Filter_size(), this.Filter_popular(), this.Sort());
                return obj;
            })(new this.$.$mol_page());
        }
        /**

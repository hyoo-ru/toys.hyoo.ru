...
(function ($) {
    let $hyoo_toys_catalog = (() => {
        class $hyoo_toys_catalog extends $.$mol_page {
            ...
            sub() {
                return [this.Head(), this.Filter_title(), this.Body()];
            }
            Filter_title() {
                return ((obj) => {
...
(function ($) {
    let $hyoo_toys = (() => {
        class $hyoo_toys extends $.$mol_book {
            ...
            pages() {
                return [this.Filters(), this.Catalog(), this.Details()];
            }
            Filters() {
                return ((obj) => {
        ...
        __decorate([
            $.$mol_mem
        ], $hyoo_toys.prototype, "keydown", null);
        __decorate([
            $.$mol_mem
